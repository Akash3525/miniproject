...
<body>
    ...
    <section id="home">
        <article class="left">
            <h1>Blood And Plasma Donation</h1>
            <p>Donate and save lives</p>
            <div class="btn-wrapper">
                <button class="btn" onclick= "window.location.href='index.php';">Donate Blood</button>
                <button class="btn" onclick= "window.location.href='pindex.php';">Donate Plasma</button>
            </div>
        </article>
        <article class="right">
            <img src="cuteBlood.png" alt="bloodPic" />
        </article>
    </section>
