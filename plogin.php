...
$page='http://localhost/cwh/phome.php';
 ?>
 <!DOCTYPE html>
...
<br><br>
  ...
  <table align="center" id="table">
    ...
    <tr>
      ...
      <td width="250px" height="80px"> <input type="password" name="ps" placeholder="Enter Password" style="font-size: 18px; width: 180px; height: 30px; border-radius: 10px" id="myInput"></td><br/>
...
if(isset($_POST['sub']))
{
  $un=$_POST['un'];
  $ps=$_POST['ps'];
$q=$db->query("SELECT * FROM padmin WHERE uname='$un' && pass='$ps'");
$q->execute();
